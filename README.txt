...
This code will run on any command line where the "python SCRIPTNAME.py" command will execute and chinese characters are recognized, which is 
supported on MacOS, Linux, and Windows terminals. 
